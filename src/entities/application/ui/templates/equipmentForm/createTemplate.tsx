...
import {equipmentApi, equipmentSelectApi} from '@box/entities/application/api/selects/equipmentSelect';
...
export const EquipmentCreateTemplate: React.FC<IEquipmentForm> = ({
                                                                      className,
                                                                      form,
                                                                      totalPrice: tp,
                ...
                <DisabledView className="w-full"
                    ...
                    <AsyncSelect
                        ...
                        onSelect={(val) => {
                            ...
                            fields.latitude.onChange(val?.value.latitude);
                            fields.longitude.onChange(val?.value.longitude);
                            fields.city.onChange(val?.value.city.id)
