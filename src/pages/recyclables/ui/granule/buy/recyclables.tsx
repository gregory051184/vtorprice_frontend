...
export const RecyclablesGranuleBuyByCategory = () => {
    ...
    if (isMobile) {
        return (
            ...
            >
                <Head>
                    <title>{recyclables.length > 0 ? `${recyclables.map(rec => rec?.category?.name)[0]} покупка` : 'Гранула покупка'}</title>
                </Head>
                <Container>
                    <BackButton/>
                    <div>
                        ...
                        >
                            {filteredRecyclableCategory().map(item =>
                                    <SwiperSlide
                                        ...
                                        onClick={() => item?.totalVolume > 0 && router.push(`/applications/granule/buy/category/recyclable/${item?.recyclable?.id}`)}
                    ...
                    <div className='mt-7'>
                        <h3>{recyclables.length > 0 ? `Компании с объявлениями по ${recyclables.map(rec => rec?.category?.name)[0]} покупка` : ''}</h3>
                    ...
                    {recyclables.length > 0 &&
                        <div className='mt-10'>
                            <h3>{`Объявления по ${recyclables.map(rec => rec?.category?.name)[0]} покупка`}</h3>
            ...
            <Container>
                ...
                <div className='inline-flex w-full mt-6'>
                    <div className='w-5/6'>
                        ...
                        {recyclables.length > 0 &&
                            <div className='mt-10'>
                                <h3>{`Объявлениями по ${recyclables.map(rec => rec?.category?.name)[0]} покупка`}</h3>
                                <FullListOfApplicationsForMainPage></FullListOfApplicationsForMainPage>
                            </div>}
                    </div>
                    <div>
