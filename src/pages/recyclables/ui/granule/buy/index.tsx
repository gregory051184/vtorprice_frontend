...
import {gate as categoryGate} from "@box/entities/category/model";
...
export const RecyclablesGranuleBuy = () => {
                        ...
                        >
                            {filtered_recyclableCategory().map(category =>
                                    <SwiperSlide
                                        ...
                                        onClick={() => category?.totalVolume > 0 && router.push(`/applications/granule/buy/category/${category?.recyclableCategory?.id}`)}
                    ...
                    <div className='w-5/6'>
                        <div className='w-full flex-wrap'>
                            {filtered_recyclableCategory().map(item => (
                                <div
                                    onClick={() => item?.totalVolume > 0 && router.push(`/applications/granule/buy/category/${item?.recyclableCategory?.id}`)}
                        ...
                        <FullListOfApplicationsForMainPage /*applications={apps.filter(app =>
                            app?.dealType?.id === dealTypeSelectValues[0]?.id &&
