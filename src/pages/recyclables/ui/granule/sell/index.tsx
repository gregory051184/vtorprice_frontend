...
export const RecyclablesGranuleSell = () => {
                        ...
                        >
                            {filtered_recyclableCategory().map(category =>
                                    <SwiperSlide
                                        ...
                                        onClick={() => category?.totalVolume > 0 && router.push(`/applications/granule/sell/category/${category?.recyclableCategory?.id}`)}
                    ...
                    <div className='w-5/6'>
                        <div className='w-full flex-wrap'>
                            {filtered_recyclableCategory().map(item => (
                                <div
                                    onClick={() => item?.totalVolume > 0 && router.push(`/applications/granule/sell/category/${item?.recyclableCategory?.id}`)}
                        ...
                        <FullListOfApplicationsForMainPage /*applications={apps.filter(app =>
                            ...
                            app?.applicationRecyclableStatus?.id === applicationRecyclableStatusSelectValues[1]?.id)}*/></FullListOfApplicationsForMainPage>
                    </div>
                    <div>
                        <MainMenuSidePanel
                            onChangeShowForm={changeShowFormHandler}
