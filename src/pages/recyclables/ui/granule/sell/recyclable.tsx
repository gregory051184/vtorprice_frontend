...
export const ApplicationsAndCompaniesByRecyclableGranuleSell = () => {
    ...
    if (isMobile) {
        return (
            ...
            >
                <Head>
                    <title>{recyclable?.id ? `Продажа (${recyclable?.name})` : 'Продажа гранулы'}</title>
                </Head>
                <Container>
                    <BackButton/>
                    <div className="mt-6">
                        <h2>{recyclable?.id ? `Продажа (${recyclable?.name})` : 'Продажа гранулы'}</h2>
                    ...
                    {(recyclable?.id && filteredRecFixed().length > 0) &&
                        <div className='mt-8'>
                            <div>
                                <h3>График изменения цены продажи</h3>
                                <div className='mt-7'>
                            ...
                            <div>
                                <h3>Диаграмма объёмов(тонн) компаний по продаже</h3>
                            ...
                            <div className='mt-10'>
                                <h3>{`Компании с контрактами на поставку по продаже ${recyclable?.name}, сортированные по городам`}</h3>
                    ...
                    {(recyclable?.id && filteredRecFixed().length > 0) &&
                        <div className='mt-10'>
                            <h3>{
                                //@ts-ignore
                                `Объявления по продаже ${recyclable?.name}`}</h3>
        ...
        >
            ...
            <Container>
                ...
                <div className="inline-flex mt-6">
                    <h1>{recyclable?.id ? `Продажа (${recyclable?.name})` : 'Продажа гранулы'}</h1>
                    <div className={'w-auto ml-5 inline-flex'}>
                        <Select
                            inputProps={{mode: "stroke"}}
                            placeholder={'Период'}
