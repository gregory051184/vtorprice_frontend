...
export const RecyclablesWasteBuy = () => {
                    ...
                    <div className='w-5/6'>
                        <div className='w-full flex-wrap'>
                            {filtered_recyclableCategory().map(item => (
                                <div
                                    key={item.recyclableCategory.id}
                                    onClick={() => item?.totalVolume > 0 && router.push(`/applications/wastes/buy/category/${item?.recyclableCategory?.id}`)}
