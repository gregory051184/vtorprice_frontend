        ...
        return (
            ...
            >
                ...
                <Container>
                    <BackButton/>
                    <div className="mt-6">
                        <h1>{recyclable?.id ? `Покупка отходы (${recyclable?.name})` : 'Покупка отходы'}</h1>
                    ...
                    {(recyclable?.id && filteredRecFixed().length > 0) &&
                        <div className='mt-7'>
                            <h3>{`Компании с объявлениями по покупке отходов ${recyclable?.name}`}</h3>
                            {
                                //@ts-ignore
                    ...
                    {(recyclable?.id && filteredRecFixed().length > 0) &&
                        <div className='mt-10'>
                            <h3>{
                                //@ts-ignore
                                `Объявлениями по покупке отходов ${recyclable?.name}`}</h3>
        ...
        >
            ...
            <Container>
                ...
                <div className="inline-flex mt-6">
                    <h1>{recyclable?.id ? `Покупка отходов (${recyclable?.name})` : 'Покупка отходов'}</h1>
