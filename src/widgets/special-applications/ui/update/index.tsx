...
import {specialAppForm} from "@box/features";
...
export const SpecialApplicationUpdateForm: React.FC<IWithClass> = ({
                                                                       className
                                                                   }) => {
    const {fields, submit, hasError, isValid, reset} = useForm(specialAppForm);
