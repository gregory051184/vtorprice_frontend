...
import {
    CompanyDocumentsFormManagement,
    CompanyNotRequiredDocumentsFormManagement
} from '@box/features/company-management/documents/ui';
...
} from '@box/features/company-management/company_activity_types/ui/supplier';
import {
    CompanyActivityTypesProcessorFormManagement
} from '@box/features/company-management/company_activity_types/ui/processor';
import {
    CompanyActivityTypesCustomerFormManagement
} from '@box/features/company-management/company_activity_types/ui/customer';
        ...
        <div className={className}>
            ...
            >
                {REQUIRED_DOCUMENTS.map((document, num) => (
                    ...
                    >
                        <div
                            className="w-[30px] shrink-0 h-[30px] rounded-full bg-secondaryGreen-light flex items-center justify-center">
            ...
            <div className='p-[16px] rounded-[20px] bg-grey-10'>
                ...
                <Tip className="mb-7">
                    "На стопе" - данная фракция пока не продаётся/покупается,
                    находится "на паузе", строка обведена оранжевым.
                    "Не на стопе" - фракция продаётся/покупается
                </Tip>
