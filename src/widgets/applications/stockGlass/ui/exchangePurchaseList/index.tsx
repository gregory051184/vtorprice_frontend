...
import {purchase} from "@box/widgets/applications";
...
import s from "@box/pages/exchange/glass/style.module.scss";
import {TabSelect} from "@box/shared/ui";
import ReactECharts from "echarts-for-react";
import {NoGraphData} from "@box/shared/ui/noGraphData";

export const ExchangePurchaseList: React.FC<IWithClass & { show?: boolean, active: number }> = ({
                                                                                                    className,
                                                                                                    show,
                                                                                                    active
                                                                                                }) => {
        ...
        <div className={className}>
            <div className={s.top}>
                <TabSelect
                    ...
                    value={period}
                />
                {hasGraphData && <p className='mx-auto text-center text-grey-40'>График изменения цены покупки</p>}
            </div>
            ...
            {lastSaleInfo && (
                <div className="mt-[30px] flex justify-end items-center gap-[20px]">
                    <p className="text-grey-40">Изменение цены покупки</p>
